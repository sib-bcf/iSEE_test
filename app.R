...
GENERATOR <- createCustomPlot(CUSTOM_GVIZ)
# cdp$Arguments <- c("\n\n\n\n")
custom_panel <- GENERATOR(bigwig_files = "SRR1039508.bw,SRR1039512.bw",
                          bigwig_names = "SRR1039508,SRR1039512",
                          bigwig_conditions = "N61311,N052611",
                          granges = "Homo_sapiens.GRCh38.93.1.1.10M.granges.rds",
                          chr = "1",
...
rdp <- RowDataPlot(XAxis = "Row data", YAxis = "edgeR.cellineN61311.cellineN052611.mlog10PValue", XAxisRowData = "edgeR.cellineN61311.cellineN052611.logFC")


# disable tour
# tour <- read.delim("tour.txt", sep = ";", quote = "")
app <- iSEE(sce, initial = list(rdp, custom_panel)
)
